            ...
            <div className = "card-container">
                ...
                <div className = "info">
                    <div className = "info-container">
                        ...
                        <a target = "_blank" rel="noreferrer" href= {props.item.googleMapsUrl}><h4 className = "googlemaps">View on Google Maps</h4></a>
                    </div>
                    <h2 className = "city">{props.item.title}</h2>
                    <h4 className = "date">{props.item.startDate} - {props.item.endDate}</h4>
                    <h4 className = "summary">{props.item.description} </h4>
                </div>
            </div>
        </div>
    )
